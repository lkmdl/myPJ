...
// 파라미터 물음표(?) 확인하기
if (pm.indexOf("?") === -1) { // indexOf값이 -1이면 물음표 없다
    alert("메뉴를 클릭하여 접근해주세욧!!!");
    location.href = "index.html";
} ///////////if///////////////

//3. 물음표와(?)와 이퀄(=)로 각각 자른후 뒤의 배열값 읽기
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // console.log("ctit변수",ctit.length);
